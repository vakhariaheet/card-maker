						...
						>
							<div className='w-24 h-24 rounded-full bg-white flex items-center justify-center shadow-lg border-2 border-gray-100 group-hover:border-[#1A1F2C] transition-all duration-300'>
								...
								>
									<g>
										<path
											d='M.708.608a.18.18 0 1 1 0-.36.18.18 0 0 1 0 .36zm.958 1.012h-.1a.04.04 0 1 1 0-.08h.04l-.077-.18h-.344l.142.18h.105a.04.04 0 1 1 0 .08H.04a.04.04 0 0 1-.036-.055l.169-.397a.04.04 0 0 1 .073.032l-.145.34h.27l.172-.426a.04.04 0 0 1 .064-.015l.495.441h.123l-.154-.195a.04.04 0 0 1 .03-.065h.394l-.032-.074H.966a.04.04 0 0 1-.024-.008l-.266-.2H.332l-.035.082a.04.04 0 1 1-.073-.031L.269.943A.04.04 0 0 1 .306.919h.328l-.11-.17A.358.358 0 0 1 .707.086.358.358 0 0 1 .893.75l-.11.17H1.4c.016 0 .03.01.037.024l.088.207v.002l.177.413a.04.04 0 0 1-.037.055zm-.237-.493L1.375.999H.809l.17.128h.45zm-.971.413h.524l-.386-.343zM.708.166a.277.277 0 0 0-.137.518.04.04 0 0 1 .014.013l.123.189.124-.189A.04.04 0 0 1 .845.684.278.278 0 0 0 .708.166zm0 .162a.1.1 0 1 0 0 .2.1.1 0 0 0 0-.2z'
											fill='#000000'
											opacity={1}
											data-original='#000000'
										/>
										<path
											fill='#f16461'
											d='M.708.886.832.697A.04.04 0 0 1 .845.684.278.278 0 0 0 .708.166a.277.277 0 0 0-.137.518.04.04 0 0 1 .014.013l.123.189zm0-.278a.18.18 0 1 1 0-.36.18.18 0 0 1 0 .36z'
											opacity={1}
											data-original='#f16461'
										/>
										<path
											fill='#fefefe'
											d='M.708.528a.1.1 0 1 0 0-.2.1.1 0 0 0 0 .2z'
											opacity={1}
											data-original='#fefefe'
										/>
										<path
											fill='#ffdb56'
											d='M.676.999H.332l-.035.081a.04.04 0 0 1-.052.021l-.02.046a.04.04 0 0 1 .021.053l-.145.34h.27l.172-.426a.04.04 0 0 1 .064-.015l.495.441h.123l-.154-.195a.04.04 0 0 1 .03-.065h.394l-.032-.074H.966a.04.04 0 0 1-.024-.008l-.266-.2z'
											opacity={1}
											data-original='#ffdb56'
										/>
										<path
											fill='#4ce166'
											d='m.596 1.197-.138.343h.524zM.98 1.127h.45L1.374.999H.809z'
											opacity={1}
											data-original='#4ce166'
										/>
										<path
											fill='#a8eefc'
											d='M1.529 1.36h-.344l.142.18h.105a.04.04 0 0 1 .04.04h.054a.04.04 0 0 1 .04-.04h.04z'
											opacity={1}
											data-original='#a8eefc'
										/>
									</g>
								</svg>
              </div>
